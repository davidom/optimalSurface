...
Generation
\thanks{The work of the second author is supported in part by NSF CAREER 
grant ACI-1330056 (formerly ACI-1054459).}
}
...
\begin{abstract}
\input{Abstract}
\keywords{optimal, refine, mesh, grid, unstructured, triangle}
\end{abstract}
