...
% NOTE:  Dave - I commented out the subsection below and put the 
%  discussion on the motivation in the following subsection.  
...
% Dave - I moved this section to the end of the Introduction section
% and reworded it.  I also added several references for surface mesh
% quality improvement.
