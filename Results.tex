...
$0.25$, \Cref{fig_RefineOnlyB} then $92$ nodes are inserted. Again, the
...
\Cref{fig_RefineOnlyC}, no more nodes are inserted. This is due to the
...
\begin{figure}[h!]
  ...
  \subfloat[$tol_{RD}=0.25$, movement during]{\label{fig_ComboC}\includegraphics[width=50mm]{Figures/Reconnect025.png}}
  \end{center}
\end{figure}
...
of $92$ nodes being inserted (\Cref{fig_ComboA}), $713$ nodes were
